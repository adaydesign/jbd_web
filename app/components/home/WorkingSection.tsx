  ...
  return (
    ...
    >
      ...
      <UnorderedList fontSize="19px" mt={6} color="black" w="70%" textAlign="left">
        ...
        <ListItem mb={2}>หลักสูตร Fellowship Program ที่ผสมผสานระหว่างการบรรยายเชิงวิชาการและ การร่วมมือกับสมาชิกกลุ่มประมาณ 6-7 คน เพื่อแก้ไข ปัญหาที่เกิดขึ้นจริงในกระบวนการยุติธรรมชั้นศาล</ListItem>
        <ListItem mb={2}>กิจกรรมของหลักสูตรจัดขึ้นที่สำนักงานศาลยุติธรรม ศาล อาญา ศาลแพ่ง และสถาบันพัฒนาข้าราชการฝ่ายตุลาการศาลยุติธรรม</ListItem>
        <ListItem mb={2}>ระยะเวลาดำเนินการของหลักสูตรทั้งสิ้น 7 วัน โดยจัดขึ้นในวันเสาร์ที่ 5, 11, 18, 25 กุมภาพันธ์ และวันเสาร์ที่ 11, 18, 25 มีนาคม 2566 เวลา 9.00-16.00 น.</ListItem>
        <ListItem mb={2}>วิทยากรผู้บรรยายมีความรู้ความเชี่ยวชาญเกี่ยวกับ กระบวนการคิดเชิงออกแบบและการพิจารณาคดีในศาล</ListItem>
