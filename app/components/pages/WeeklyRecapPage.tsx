            ...
            <AccordionButton _expanded={{ bg: "red", color: "white" }}>
              <Box as="span" flex="1" textAlign="left">
                <Text as="b" fontSize="22px">
                  Update! การอบรมหลักสูตร Justice x Design: Week 1 ( 4
          ...
          <AccordionPanel pb={4}>
            <Box p={10} shadow="2xl">
              <Center flexDirection="column">
                ...
                >
                  <a
                    href="https://drive.google.com/drive/folders/14lRM6qMLZJpsDMr6nTGqcM_E4j8WohUC?usp=sharing"
                    target="_blank"
                  >
                    -More Photos-
                  </a>
              ...
              >
                ...
                จากนั้นทีมงานหลักสูตร Justice x Design ประกอบไปด้วย ทีมงานจาก
                COJ, LUKKID และ TIJ
              ...
              <Text fontSize="19px" lineHeight="9" textIndent="70px">
                - การทำให้ประชาชนสามารถดำเนินคดีเองได้โดยง่าย (More
                Independence)
              </Text>
              <Text fontSize="19px" lineHeight="9" textIndent="70px">
